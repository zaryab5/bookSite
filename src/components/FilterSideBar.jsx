...
export default function FilterSideBar() {
  ...
  const items = ['Mockups', 'Templates', 'Design', 'Logos','Very Big Thing'];
  ...
  return (
    <div className="bg-white">
      <div className=' mt-40 text-center'>
                    {/* <input type="search" name='search' id='search' placeholder='Search a Book' className='py-2 px-2 rounded-s-sm outline-none lg:w-[500px] box-border' />
                    <button className='bg-blue bg-blue-700 px-6 py-2 box-border text-white font-medium hover:bg-black transition-all ease-in duration-200'>Search</button>
                */}
...
<form  className=' flex justify-center'>
      <div className="flex lg:w-[700px] text-center">
      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Books Collection</h1>
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-[200px_1fr]">
              {/* Filters */}
              ...
              {/* Product grid */}
              <div className="grid gap-8 lg:grid-cols-4 sm:grid-cols-2 md:grid-cols-3 grid-cols-1 self-start">
                 {
                      ...
                      imgSrc={book.imageUrl}
                       ...
                       >
                        ...
                        <p className="font-normal text-gray-700 dark:text-gray-400">
                          {book.bookDescription.split(' ').slice(0, 10).join(' ')}
                        </p>
                        <button className=' mt-5 bg-blue-700 text-white font-semibold px-5 py-2 rounded hover:bg-black transition-all duration-300'>Buy Now</button>
                        </div>
                      </Card>
