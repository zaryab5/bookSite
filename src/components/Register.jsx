				...
				<div className="divide-y divide-gray-200">
					<form onSubmit={(e)=>handleSubmit(e)} className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
						<div className="relative">
							<input autoComplete="off" id="name" name="name" type="text" className=" border-none outline-none focus:outline-none peer placeholder-transparent transition-all ease-in duration-100 h-10 w-full border-b-2 border-gray-300 text-gray-900  focus:borer-rose-600 p-5" placeholder="Name" />
